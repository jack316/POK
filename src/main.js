...
POKEDEXFLAGS['releasedNormal'] = 3; // 釋放到野外
POKEDEXFLAGS['releasedShiny'] = 4; // 釋放到野外
POKEDEXFLAGS['ownedNormal'] = 5; // 從進化得到
POKEDEXFLAGS['ownNormal'] = 6; // 在當前陣容中
POKEDEXFLAGS['ownedShiny'] = 7; // 從進化得到
POKEDEXFLAGS['ownShiny'] = 8; // 在當前陣容中
...
$('#version').innerHTML = '版本 ' + gameVersion;
